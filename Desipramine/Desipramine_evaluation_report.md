...
This desipramine model is intended to describe plasma concentration-time profiles of desipramine and 2-hydroxydesipramine after intravenous and oral administration. It supports CYP2D6 drug-gene and drug-drug-gene interaction simulations in the CYP2D6 network described by [Rüdesheim 2025](References.md#5-references).
...
| --- | ---: | ---: | --- | --- |
| Desipramine MW | g/mol | 266.4 | [PubChem 2019](References.md#5-references) | Parent compound size used in concentration conversions. |
| Desipramine pK<sub>a</sub> | - | 2.84, 10.02 | [ChemAxon 2023](References.md#5-references); [DrugBank 2006](References.md#5-references) | Ionization constants. |
| Desipramine logP | - | 3.52 | Optimized; [ChemAxon 2023](References.md#5-references); [DrugBank 2006](References.md#5-references) | Distribution-sensitive parent parameter. |
| Desipramine f<sub>u</sub> | % | 14 | [Watanabe 2018](References.md#5-references) | Plasma binding input. |
| CYP2D6 K<sub>m</sub>, desipramine to 2-hydroxydesipramine | µmol/L | 0.73 | [Ball 1997](References.md#5-references); [Austin 2002](References.md#5-references) | CYP2D6 affinity held constant across phenotypes. |
...
| --- | --- |
| [Brøsen 1988](References.md#5-references) | Plasma PK profiles in adults after intravenous administration of 50 mg desipramine hydrochloride with CYP2D6 poor-, extensive-, and fast-metabolizer status. |
| [Spina 1987](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 25 mg desipramine hydrochloride with CYP2D6 poor- and extensive-metabolizer status. |
| [Aarnoutse 2005](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with CYP2D6 extensive-metabolizer status. |
| [Boni 2009](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with desipramine and 2-hydroxydesipramine measurements. |
| [Harris 2007](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with CYP2D6 extensive-metabolizer status. |
| [Madani 2002](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with CYP2D6 extensive-metabolizer status. |
| [Brøsen 1986](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 100 mg desipramine hydrochloride with CYP2D6 poor-, extensive-, and fast-metabolizer status. |

Model-verification clinical data:

| Publication | Arm / Treatment / Information used for model verification |
| --- | --- |
| [Bergmann 2001](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 100 mg desipramine hydrochloride with CYP2D6 AS = 2 and AS = 2.5 status. |
| [Hynes 2015](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with CYP2D6 extensive-metabolizer status. |
| [Bergstrom 1992](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride. |
| [Nichols 2013](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with CYP2D6 extensive-metabolizer status. |
| [Patroneva 2008](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with desipramine and 2-hydroxydesipramine measurements. |
| [Skinner 2003](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg desipramine hydrochloride with CYP2D6 extensive-metabolizer status. |
| [Spina 1995](References.md#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 100 mg desipramine hydrochloride with CYP2D6 extensive-metabolizer status. |
...
The model-building data informed systemic disposition, oral absorption, CYP2D6-mediated 2-hydroxylation, residual hepatic clearance, and metabolite elimination. Intravenous and oral phenotype-stratified data from [Brøsen 1988](References.md#5-references), [Brøsen 1986](References.md#5-references), and [Spina 1987](References.md#5-references) supported CYP2D6 phenotype-dependent clearance. Oral studies with parent and metabolite measurements, including [Boni 2009](References.md#5-references), supported the parent-metabolite structure. Additional oral data from [Aarnoutse 2005](References.md#5-references), [Harris 2007](References.md#5-references), and [Madani 2002](References.md#5-references) supported adult oral exposure after 50 mg dosing.

Verification used independent studies across CYP2D6 activity and interaction settings, including [Bergmann 2001](References.md#5-references), [Hynes 2015](References.md#5-references), [Bergstrom 1992](References.md#5-references), [Nichols 2013](References.md#5-references), [Patroneva 2008](References.md#5-references), [Skinner 2003](References.md#5-references), and [Spina 1995](References.md#5-references). These data test whether the same model can describe adult oral desipramine exposure without study-specific refitting.
...
[Rüdesheim 2025](References.md#5-references) used the desipramine model in a broader CYP2D6 DDGI network. In that setting, desipramine served as a sensitive CYP2D6 substrate for inhibition and genotype interaction scenarios. The present evaluation should therefore be read as a compound-level check of desipramine and 2-hydroxydesipramine exposure, while DDGI performance depends additionally on perpetrator models and interaction constants.
...
Below you find the goodness-of-fit visual diagnostic plots for the PBPK model performance of all data used presented in [Section 2.2.2](Section2.2_Data.md).
