...
| Version                                         | evaluation-fork-fix-OSP12.2                                                   |
| ----------------------------------------------- | ------------------------------------------------------------ |
| based on *Model Snapshot* and *Evaluation Plan* | https://github.com/Open-Systems-Pharmacology/Desipramine-Model/releases/tag/vevaluation-fork-fix |
| OSP Version                                     | 12.2                                                          |
...
Desipramine is a tricyclic antidepressant and a sensitive CYP2D6 substrate. Its pharmacokinetics are suitable for evaluating CYP2D6 phenotype- and activity-dependent changes in exposure.

This desipramine model is intended to describe plasma concentration-time profiles of desipramine and 2-hydroxydesipramine after intravenous and oral administration across CYP2D6 phenotype and activity-score groups.

The model was developed using physicochemical, *in vitro*, and clinical pharmacokinetic information for desipramine and 2-hydroxydesipramine. Clinical data included intravenous and oral administration and poor-, extensive-, normal-, and higher-activity CYP2D6 groups. This compound report includes only desipramine-only or control-arm pharmacokinetic data.
...
The desipramine parent-metabolite PBPK model was reported by [Rüdesheim 2025](#5). The model was built using intravenous and oral desipramine data to inform distribution, absorption, CYP2D6-mediated metabolism, and residual elimination.

Clinical studies used for model building covered intravenous and oral desipramine administration in CYP2D6 poor-, extensive-, and fast-metabolizer groups. Verification simulations included independent oral studies and activity-score groups. The model therefore separates parent desipramine performance from 2-hydroxydesipramine performance where metabolite data are available.
...
The evaluated applications include intravenous infusion or bolus dosing and oral dosing. The major proteins and processes represented explicitly are CYP2D6, plasma protein binding, residual hepatic clearance, and passive renal filtration.
...
No phenotype-specific absorption parameter was introduced. Differences between CYP2D6 groups are represented through metabolism, while the same oral absorption assumptions are applied across adult simulations.

### Distribution

Desipramine plasma protein binding was represented by a fraction unbound of 14% as summarized in [Section 2.2.1](#22). Lipophilicity was optimized and is an important parameter for the parent volume of distribution.

Partition coefficients were calculated with the Rodgers and Rowland method. Cellular permeabilities were calculated with the PK-Sim Standard method. Because the model includes both parent and metabolite concentration-time profiles, distribution assumptions affect the interpretation of desipramine and 2-hydroxydesipramine profiles separately.
...
This structure assigns CYP2D6 phenotype and activity-score effects to catalytic capacity rather than to affinity.
...
The PBPK model for desipramine was developed and evaluated with clinical pharmacokinetic data after intravenous and oral administration. The evaluation covers desipramine and 2-hydroxydesipramine plasma concentration-time profiles and CYP2D6 poor-, extensive-, normal-, and higher-activity groups. It includes compound-only or control-arm profiles.

The model-building data informed systemic disposition, oral absorption, CYP2D6-mediated 2-hydroxylation, residual hepatic clearance, and metabolite elimination. Intravenous and oral phenotype-stratified data from [Brøsen 1988](#5), [Brøsen 1986](#5), and [Spina 1987](#5) supported CYP2D6 phenotype-dependent clearance. Oral studies with parent and metabolite measurements, including [Boni 2009](#5), supported the parent-metabolite structure. Additional oral data from [Aarnoutse 2005](#5), [Harris 2007](#5), and [Madani 2002](#5) supported adult oral exposure after 50 mg dosing.

Verification used independent studies across CYP2D6 activity groups, including compound-only or control-arm data from [Bergmann 2001](#5), [Hynes 2015](#5), [Bergstrom 1992](#5), [Nichols 2013](#5), [Patroneva 2008](#5), [Skinner 2003](#5), and [Spina 1995](#5). These data test whether the same model can describe adult oral desipramine exposure without study-specific refitting.

The model quantifies CYP2D6-mediated 2-hydroxylation, residual hepatic clearance of desipramine, unspecific hepatic clearance of 2-hydroxydesipramine, and passive glomerular filtration. CYP2D6 k<sub>cat</sub> values represent the major phenotype and activity-score dependency. The metabolite pathway is important because adequate parent prediction alone would not demonstrate correct description of 2-hydroxydesipramine exposure.
...
The concentration-time profiles and goodness-of-fit diagnostics characterize model performance within the evaluated intravenous and oral dose range, analytes, and CYP2D6 groups. Unrepresented populations and tissue-specific pharmacodynamic endpoints remain outside the evidence evaluated in this report.
...
The goodness-of-fit diagnostics are separated by analyte. This keeps desipramine and 2-hydroxydesipramine legends and error measures distinct.
...
**Table 3-1: GMFE for Desipramine goodness-of-fit diagnostics**
...
**Figure 3-1: Desipramine goodness-of-fit diagnostics**
...
**Figure 3-2: Desipramine goodness-of-fit diagnostics**
...
The goodness-of-fit diagnostic plots show 2-hydroxydesipramine plasma concentration data used in the model evaluation.

The first plot shows observed versus simulated plasma concentrations. The second plot shows weighted residuals versus time.

<a id="table-3-2"></a>

**Table 3-2: GMFE for 2-Hydroxydesipramine goodness-of-fit diagnostics**

|Group                |GMFE |
|:--------------------|:----|
|2-Hydroxydesipramine |1.22 |
...
**Figure 3-3: 2-Hydroxydesipramine goodness-of-fit diagnostics**
...
**Figure 3-4: 2-Hydroxydesipramine goodness-of-fit diagnostics**
...
**Figure 3-5: Aarnoutse 2005: desipramine hydrochloride, po, 50 mg, n=13 (EM)**
...
![](images/006_section_3/011_section_33/012_section_331/2_time_profile_plot_Desipramine_Boni__2009____desipramine_hydrochloride__po__50_mg__n_26__EM_.png)

**Figure 3-6: Boni 2009: desipramine hydrochloride, po, 50 mg, n=26 (EM)**
...
![](images/006_section_3/011_section_33/012_section_331/3_time_profile_plot_Desipramine_Brosen__1986____desipramine_hydrochloride__po__100_mg__n_6__fast_EM_.png)

**Figure 3-7: Brøsen 1986: desipramine hydrochloride, po, 100 mg, n=6 (fast EM)**
...
![](images/006_section_3/011_section_33/012_section_331/4_time_profile_plot_Desipramine_Brosen__1986____desipramine_hydrochloride__po__100_mg__n_6__PM_.png)

**Figure 3-8: Brøsen 1986: desipramine hydrochloride, po, 100 mg, n=6 (PM)**
...
![](images/006_section_3/011_section_33/012_section_331/5_time_profile_plot_Desipramine_Brosen__1986____desipramine_hydrochloride__po__100_mg__n_6__EM_.png)

**Figure 3-9: Brøsen 1986: desipramine hydrochloride, po, 100 mg, n=6 (EM)**
...
![](images/006_section_3/011_section_33/012_section_331/6_time_profile_plot_Desipramine_Brosen__1988____desipramine_hydrochloride__iv__50_mg__n_4__fast_EM_.png)

**Figure 3-10: Brøsen 1988: desipramine hydrochloride, iv, 50 mg, n=4 (fast EM)**
...
![](images/006_section_3/011_section_33/012_section_331/7_time_profile_plot_Desipramine_Brosen__1988____desipramine_hydrochloride__iv__50_mg__n_3__PM_.png)

**Figure 3-11: Brøsen 1988: desipramine hydrochloride, iv, 50 mg, n=3 (PM)**
...
![](images/006_section_3/011_section_33/012_section_331/8_time_profile_plot_Desipramine_Brosen__1988____desipramine_hydrochloride__iv__50_mg__n_4__EM_.png)

**Figure 3-12: Brøsen 1988: desipramine hydrochloride, iv, 50 mg, n=4 (EM)**
...
![](images/006_section_3/011_section_33/012_section_331/9_time_profile_plot_Desipramine_Harris__2007____desipramine_hydrochloride__po__50_mg__n_17__EM_.png)

**Figure 3-13: Harris 2007: desipramine hydrochloride, po, 50 mg, n=17 (EM)**
...
**Figure 3-14: Madani 2002: desipramine hydrochloride, po, 50 mg, n=24 (EM)**
...
![](images/006_section_3/011_section_33/012_section_331/11_time_profile_plot_Desipramine_Spina__1987____desipramine_hydrochloride__po__25_mg__n_8__EM_.png)

**Figure 3-15: Spina 1987: desipramine hydrochloride, po, 25 mg, n=8 (EM)**
...
![](images/006_section_3/011_section_33/012_section_331/12_time_profile_plot_Desipramine_Spina__1987____desipramine_hydrochloride__po__25_mg__n_6__PM_.png)

**Figure 3-16: Spina 1987: desipramine hydrochloride, po, 25 mg, n=6 (PM)**
...
![](images/006_section_3/011_section_33/013_section_332/13_time_profile_plot_Desipramine_Bergmann__2001____desipramine_hydrochloride__po__100_mg__n_6__AS_2_.png)

**Figure 3-17: Bergmann 2001: desipramine hydrochloride, po, 100 mg, n=6 (AS=2)**
...
![](images/006_section_3/011_section_33/013_section_332/14_time_profile_plot_Desipramine_Bergmann__2001____desipramine_hydrochloride__po__100_mg__n_6__AS_2_5_.png)

**Figure 3-18: Bergmann 2001: desipramine hydrochloride, po, 100 mg, n=6 (AS=2.5)**
...
![](images/006_section_3/011_section_33/013_section_332/15_time_profile_plot_Desipramine_Bergstrom__1992____desipramine_hydrochloride__po__50_mg__n_6__EM_.png)

**Figure 3-19: Bergstrom 1992: desipramine hydrochloride, po, 50 mg, n=6**
...
![](images/006_section_3/011_section_33/013_section_332/16_time_profile_plot_Desipramine_Hynes__2015____desipramine_hydrochloride__po__50_mg__n_20__EM_.png)

**Figure 3-20: Hynes 2015: desipramine hydrochloride, po, 50 mg, n=20 (EM)**
...
![](images/006_section_3/011_section_33/013_section_332/17_time_profile_plot_Desipramine_Nichols__2013____desipramine_hydrochloride__po__50_mg__n_38__EM_.png)

**Figure 3-21: Nichols 2013: desipramine hydrochloride, po, 50 mg, n=38 (EM)**
...
![](images/006_section_3/011_section_33/013_section_332/18_time_profile_plot_Desipramine_Patroneva__2008____desipramine_hydrochloride__po__50_mg__n_20__EM_.png)

**Figure 3-22: Patroneva 2008: desipramine hydrochloride, po, 50 mg, n=20 (EM)**
...
**Figure 3-23: Skinner 2003: desipramine hydrochloride, po, 50 mg, n=16 (EM)**
...
**Figure 3-24: Spina 1995: desipramine hydrochloride, po, 100 mg, n=6 (EM)**
...
The desipramine PBPK model describes the evaluated plasma concentration-time data for desipramine and 2-hydroxydesipramine after intravenous administration of 50 mg and oral doses of 25-100 mg in adults. The evaluation includes CYP2D6 poor, extensive, normal, and higher-activity groups represented by phenotype or activity score.

The model uses common absorption and distribution parameters across CYP2D6 groups. CYP2D6 forms 2-hydroxydesipramine, while residual hepatic clearance and passive glomerular filtration contribute to parent and metabolite elimination. CYP2D6 characterization-specific catalytic rates describe the observed exposure differences across the evaluated groups.

The concentration-time profiles and goodness-of-fit diagnostics characterize model performance within the evaluated dose, route, analyte, and CYP2D6 ranges. No formal acceptance criterion was applied. This compound report evaluates only desipramine-only or control study arms.

The main limitations are unresolved genotype differences within activity scores, empirical residual clearance, and limited metabolite data.

# 5 References<a id="5"></a>

[1] Rüdesheim S, Loer HLH, Feick D, Marok FZ, Fuhr LM, Selzer D, et al. A Comprehensive CYP2D6 Drug-Drug-Gene Interaction Network for Application in Precision Dosing and Drug Development. Clin Pharmacol Ther. 2025. doi: [10.1002/cpt.3604](https://doi.org/10.1002/cpt.3604).

[2] Brøsen K, Gram LF. First-pass metabolism of imipramine and desipramine: impact of the sparteine oxidation phenotype. Clin Pharmacol Ther. 1988;43:400-406. doi: [10.1038/clpt.1988.50](https://doi.org/10.1038/clpt.1988.50).

[3] Spina E, Steiner E, Ericsson Ö, Sjöqvist F. Hydroxylation of desmethylimipramine: dependence on the debrisoquin hydroxylation phenotype. Clin Pharmacol Ther. 1987;41:314-319. doi: [10.1038/clpt.1987.33](https://doi.org/10.1038/clpt.1987.33).

[4] Aarnoutse RE, Kleinnijenhuis J, Koopmans PP, Touw DJ, Wieling J, Hekster YA, Burger DM. Effect of low-dose ritonavir on CYP2D6 activity in healthy volunteers. Clin Pharmacol Ther. 2005;78:664-674. doi: [10.1016/j.clpt.2005.09.001](https://doi.org/10.1016/j.clpt.2005.09.001).

[5] Boni J, Abbas R, Leister C, Burns J, Jordan R, Hoffmann M, DeMaio W, Hug B. Disposition of desipramine when coadministered with intravenous temsirolimus. Cancer Chemother Pharmacol. 2009;64:263-270. doi: [10.1007/s00280-008-0865-9](https://doi.org/10.1007/s00280-008-0865-9).

[6] Harris RZ, Salfi M, Posvar E, Hoelscher D, Padhi D. Pharmacokinetics of desipramine HCl when administered with cinacalcet HCl. Eur J Clin Pharmacol. 2007;63:159-163. doi: [10.1007/s00228-006-0129-8](https://doi.org/10.1007/s00228-006-0129-8).

[7] Madani S, Barilla D, Cramer J, Wang Y, Paul C. Effect of terbinafine on desipramine pharmacokinetics and pharmacodynamics. J Clin Pharmacol. 2002;42:1211-1218. doi: [10.1177/009127002762491299](https://doi.org/10.1177/009127002762491299).

[8] Bergstrom RF, Peyton AL, Lemberger L. Quantification and mechanism of the fluoxetine and tricyclic antidepressant interaction. Clin Pharmacol Ther. 1992;51:239-248. doi: [10.1038/clpt.1992.18](https://doi.org/10.1038/clpt.1992.18).

[9] Bergmann TK, Bathum L, Brøsen K. Duplication of CYP2D6 predicts high clearance of desipramine. Eur J Clin Pharmacol. 2001;57:123-127. doi: [10.1007/s002280100284](https://doi.org/10.1007/s002280100284).

[10] Hynes SM, Wickremsinhe E, Zhang W, Decker R, Ott J, Chandler J, Mitchell M. Evaluation of LY2603618 to inhibit CYP2D6 with desipramine as probe substrate. Biopharm Drug Dispos. 2015;36:49-63. doi: [10.1002/bdd.1922](https://doi.org/10.1002/bdd.1922).

[11] Nichols AI, Chen Y, Behrle JA, Frick G, Paul J. Effects of desvenlafaxine on the pharmacokinetics of desipramine in healthy adults. Int Clin Psychopharmacol. 2013;28:99-105. doi: [10.1097/YIC.0b013e32835c1f49](https://doi.org/10.1097/YIC.0b013e32835c1f49).

[12] Patroneva A, Connolly SM, Fatato P, Pedersen R, Jiang Q, Paul J, Guico-Pabia C, Isler JA, Burczynski ME, Nichols AI. Effect of desvenlafaxine and duloxetine on desipramine pharmacokinetics. Drug Metab Dispos. 2008;36:2484-2491. doi: [10.1124/dmd.108.021527](https://doi.org/10.1124/dmd.108.021527).

[13] Skinner MH, Kuan HY, Pan A, Sathirakul K, Knadler MP, Gonzales CR, Yeo KP, Reddy S, Lim M, Ayan-Oshodi M, Wise SD. Duloxetine is both an inhibitor and a substrate of CYP2D6. Clin Pharmacol Ther. 2003;73:170-177. doi: [10.1067/mcp.2003.28](https://doi.org/10.1067/mcp.2003.28).

[14] Kim S, Chen J, Cheng T, Gindulyte A, He J, He S, Li Q, Shoemaker BA, Thiessen PA, Yu B, Zaslavsky L, Zhang J, Bolton EE. PubChem 2019 update: improved access to chemical data. Nucleic Acids Res. 2019;47:D1102-D1109. doi: [10.1093/nar/gky1033](https://doi.org/10.1093/nar/gky1033).

[15] Swain M. chemicalize.org. J Chem Inf Model. 2012;52:613-615. doi: [10.1021/ci300046g](https://doi.org/10.1021/ci300046g).

[16] Wishart DS, Knox C, Guo AC, et al. DrugBank: a comprehensive resource for in silico drug discovery and exploration. Nucleic Acids Res. 2006;34:D668-D672. doi: [10.1093/nar/gkj067](https://doi.org/10.1093/nar/gkj067).

[17] Watanabe R, Esaki T, Kawashima H, et al. Predicting Fraction Unbound in Human Plasma from Chemical Structure. Mol Pharm. 2018;15:5302-5311. doi: [10.1021/acs.molpharmaceut.8b00785](https://doi.org/10.1021/acs.molpharmaceut.8b00785).

[18] Ball SE, Ahern D, Scatina J, Kao J. Venlafaxine: in vitro inhibition of CYP2D6-dependent imipramine and desipramine metabolism. Br J Clin Pharmacol. 1997;43:619-626. doi: [10.1046/j.1365-2125.1997.00591.x](https://doi.org/10.1046/j.1365-2125.1997.00591.x).

[19] Austin RP, Barton P, Cockroft SL, Wenlock MC, Riley RJ. Influence of nonspecific microsomal binding on apparent intrinsic clearance. Drug Metab Dispos. 2002;30:1497-1503. doi: [10.1124/dmd.30.12.1497](https://doi.org/10.1124/dmd.30.12.1497).

[20] Kuepfer L, Niederalt C, Wendl T, Schlender JF, Willmann S, Lippert J, Block M, Eissing T, Teutonico D. Applied Concepts in PBPK Modeling: How to Build a PBPK/PD Model. CPT Pharmacometrics Syst Pharmacol. 2016;5:516-531. doi: [10.1002/psp4.12134](https://doi.org/10.1002/psp4.12134).

[21] Willmann S, Höhn K, Edginton A, Sevestre M, Solodenko J, Weiss W, Lippert J, Schmitt W. Development of a physiology-based whole-body population model for assessing the influence of individual variability on the pharmacokinetics of drugs. J Pharmacokinet Pharmacodyn. 2007;34:401-431. doi: [10.1007/s10928-007-9059-5](https://doi.org/10.1007/s10928-007-9059-5).

[22] Brøsen K, Otton SV, Gram LF. Imipramine demethylation and hydroxylation: impact of the sparteine oxidation phenotype. Clin Pharmacol Ther. 1986;40:543-549. doi: [10.1038/clpt.1986.221](https://doi.org/10.1038/clpt.1986.221).

[23] Spina E, Avenoso A, Campo GM, Caputi AP, Perucca E. The effect of carbamazepine on the 2-hydroxylation of desipramine. Psychopharmacology. 1995;117:413-416. doi: [10.1007/BF02246212](https://doi.org/10.1007/BF02246212).
