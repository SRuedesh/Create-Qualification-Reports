 ...
 * [1 Introduction and Qualification Network](#introduction)
   * [1.1 Objective](#objective)
   * [1.2 CYP2D6 DDGI Network](#cyp2d6-ddgi-network)
 * [2 Qualification of CYP2D6-Mediated Interactions](#ddi-evaluations)
   * [2.1 Perpetrator and Victim Evaluations](#ddi-study-evaluations)
   ...
   * [2.2 Genotype or Phenotype Evaluations](#dgi-parent-model-evaluations)
     * [2.2.1 Atomoxetine DGI](#atomoxetine-dgi)
     * [2.2.2 Clomiphene DGI](#clomiphene-dgi)
     * [2.2.3 Desipramine DGI](#desipramine-dgi)
     * [2.2.4 Dextromethorphan DGI](#dextromethorphan-dgi)
     * [2.2.5 Metoprolol DGI](#metoprolol-dgi)
     * [2.2.6 Mexiletine DGI](#mexiletine-dgi)
     * [2.2.7 Risperidone DGI](#risperidone-dgi)
   * [2.3 DGI Ratio Plots](#dgi-ratio-plots)
   * [2.4 DDGI Evaluations](#ddgi-evaluations)
     * [2.4.1 DDGI Study Evaluations](#ddgi-study-evaluations)
       * [2.4.1.1 Paroxetine - Atomoxetine DDGI](#paroxetine-atomoxetine-ddgi)
       * [2.4.1.2 Clarithromycin - Clomiphene DDGI](#clarithromycin-clomiphene-ddgi)
       * [2.4.1.3 Paroxetine - Clomiphene DDGI](#paroxetine-clomiphene-ddgi)
       * [2.4.1.4 Paroxetine - Desipramine DDGI](#paroxetine-desipramine-ddgi)
       * [2.4.1.5 Paroxetine - Dextromethorphan DDGI](#paroxetine-dextromethorphan-ddgi)
       * [2.4.1.6 Quinidine - Metoprolol DDGI](#quinidine-metoprolol-ddgi)
       * [2.4.1.7 Quinidine - Mexiletine DDGI](#quinidine-mexiletine-ddgi)
 * [3 Concentration-Time Profiles](#concentration-time-profiles)
   * [3.1 DDI Concentration-Time Profiles](#ddi-concentration-time-profiles)
     ...
     * [3.1.6 Clarithromycin - Clomiphene DDGI](#clarithromycin-clomiphene-ddgi-timeprofile)
     ...
     * [3.1.15 Paroxetine - Atomoxetine DDGI](#paroxetine-atomoxetine-ddgi-timeprofile)
     * [3.1.16 Paroxetine - Clomiphene DDGI](#paroxetine-clomiphene-ddgi-timeprofile)
     * [3.1.17 Paroxetine - Desipramine DDGI](#paroxetine-desipramine-ddgi-timeprofile)
     * [3.1.18 Paroxetine - Dextromethorphan DDGI](#paroxetine-dextromethorphan-ddgi-timeprofile)
     ...
     * [3.1.23 Quinidine - Metoprolol DDGI](#quinidine-metoprolol-ddgi-timeprofile)
     * [3.1.24 Quinidine - Mexiletine DDGI](#quinidine-mexiletine-ddgi-timeprofile)
   ...
   * [3.2 DGI Concentration-Time Profiles](#dgi-concentration-time-profiles)
     ...
     * [3.2.7 Risperidone DGI](#risperidone-dgi-timeprofile)
...
# 1 Introduction and Qualification Network<a id="introduction"></a>
...
*Evaluation reports* including descriptions of model building and detailed evaluations of the included models are documented separately. The models and interaction scenarios included in this qualification are summarized in [Section 1.2](#cyp2d6-ddgi-network).

Please refer to the [Appendix](#appendix) for further details:

- An overview of the Open Systems Pharmacology (OSP) Suite is given in [Section 7.1](#osp-introduction).

- [Section 7.2](#mathematical-implementation-of-ddi) describes the implementation of the underlying mathematical equations for DDIs in the OSP Suite.

- A general description of the qualification workflow (*qualification plan*, *qualification report*, etc.) is provided in [Section 7.3](#automatic-requalification-workflow).
...
![](images/004_section_ddi-evaluations/DDIRatio_1_ddi_ratio_plot_AUC_predictedVsObserved.png)
...
![](images/004_section_ddi-evaluations/DDIRatio_1_ddi_ratio_plot_AUC_residualsVsObserved.png)
...
![](images/004_section_ddi-evaluations/DDIRatio_1_ddi_ratio_plot_CMAX_predictedVsObserved.png)

**Figure 2-3: CYP2D6 DDIs.  Predicted vs. Observed CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
![](images/004_section_ddi-evaluations/DDIRatio_1_ddi_ratio_plot_CMAX_residualsVsObserved.png)

**Figure 2-4: CYP2D6 DDIs.  Predicted/Observed vs. Observed CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
**Table 2-2: Summary table for CYP2D6 DDIs - AUC Ratio. (&delta; = 1.25 in Guest *et al.* formula)**

|AUC                          |Number |Ratio [%] |
|:----------------------------|:------|:---------|
|Points total                 |49     |-        |
|Points within Guest *et al.* |42     |85.71     |
...
**Table 2-3: Summary table for CYP2D6 DDIs - CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**

|CMAX                         |Number |Ratio [%] |
|:----------------------------|:------|:---------|
|Points total                 |48     |-        |
|Points within Guest *et al.* |39     |81.25     |
...
## 2.1 Perpetrator and Victim Evaluations<a id="ddi-study-evaluations"></a>
...
The fluvoxamine-atomoxetine interaction was evaluated using the crossover dataset summarized in [Table 2-6](#table-2-6). The [released simulation snapshot](https://github.com/Open-Systems-Pharmacology/Fluvoxamine-Atomoxetine-DDI/blob/main/Fluvoxamine-Atomoxetine-DDI.json) compares atomoxetine exposure without and with fluvoxamine-mediated CYP2D6 inhibition.

| **Data identifier** | **Enzyme** | **Perpetrator** | **Victim and dose** | **Treatment schedule** | **Population** | **Clinical reference** |
| --- | --- | --- | --- | --- | --- | --- |
| Todor 2017 - Atomoxetine - po, 25 mg, sd | CYP2D6 | None | Atomoxetine, 25 mg oral single dose | Reference period without fluvoxamine | 18 European male participants | [Todor 2017](#references) |
| Todor 2017 - DDI - Fluvoxamine-Atomoxetine - po, 25 mg, sd, day 6 | CYP2D6 | Fluvoxamine | Atomoxetine, 25 mg oral single dose | Six-day oral fluvoxamine pretreatment at 50-100 mg/day, followed by coadministration of fluvoxamine 100 mg and atomoxetine 25 mg on the test day | 18 European male participants | [Todor 2017](#references) |

**Table 2-6: Study design for the fluvoxamine-atomoxetine DDI evaluation.**<a id="table-2-6"></a> DDI: drug-drug interaction. Doses refer to the administered base-equivalent amount used in the simulations where salts were administered clinically.
...
## 2.2 Genotype or Phenotype Evaluations<a id="dgi-parent-model-evaluations"></a>

### 2.2.1 Atomoxetine DGI<a id="atomoxetine-dgi"></a>
...
### 2.2.2 Clomiphene DGI<a id="clomiphene-dgi"></a>
...
### 2.2.3 Desipramine DGI<a id="desipramine-dgi"></a>
...
### 2.2.4 Dextromethorphan DGI<a id="dextromethorphan-dgi"></a>

The Dextromethorphan DGI evaluation uses the `Dextromethorphan-Model` parent model source. It includes CYP2D6 activity-score comparisons for dextromethorphan and dextrorphan from Capon 1996, Gorski 2004, Qiu 2016, Storelli 2018, and Yamazaki 2017.

The available DGI ratio mappings include the following endpoints:

| Endpoint | Evidence |
| --- | --- |
| Dextromethorphan | Five study-specific activity-score comparisons |
| Dextrorphan | One activity-score comparison |

The scientific check is study-specific parent-metabolite consistency. Higher CYP2D6 activity is expected to reduce dextromethorphan exposure and to alter dextrorphan formation. Differences in dose, formulation, and activity-score grouping preclude pooling these studies into a single exposure-response trend.

### 2.2.5 Metoprolol DGI<a id="metoprolol-dgi"></a>
...
### 2.2.6 Mexiletine DGI<a id="mexiletine-dgi"></a>
...
### 2.2.7 Risperidone DGI<a id="risperidone-dgi"></a>
...
## 2.3 DGI Ratio Plots<a id="dgi-ratio-plots"></a>
...
Ratios are only included where a matching observed ratio record and matching parent-model DGI simulations are available. The current DGI ratio section includes clomiphene, atomoxetine, and risperidone activity-score comparisons with AS 2 as the within-study reference group. **(δ = 1.25 in Guest** ***et al.*** **formula)**

<a id="figure-2-5"></a>

![](images/004_section_ddi-evaluations/037_section_dgi-ratio-plots/DDIRatio_3_ddi_ratio_plot_AUC_predictedVsObserved.png)

**Figure 2-5: CYP2D6 DGIs.  Predicted vs. Observed AUC Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
![](images/004_section_ddi-evaluations/037_section_dgi-ratio-plots/DDIRatio_3_ddi_ratio_plot_AUC_residualsVsObserved.png)

**Figure 2-6: CYP2D6 DGIs.  Predicted/Observed vs. Observed AUC Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
![](images/004_section_ddi-evaluations/037_section_dgi-ratio-plots/DDIRatio_3_ddi_ratio_plot_CMAX_predictedVsObserved.png)

**Figure 2-7: CYP2D6 DGIs.  Predicted vs. Observed CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
![](images/004_section_ddi-evaluations/037_section_dgi-ratio-plots/DDIRatio_3_ddi_ratio_plot_CMAX_residualsVsObserved.png)

**Figure 2-8: CYP2D6 DGIs.  Predicted/Observed vs. Observed CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
**Table 2-5: GMFE for CYP2D6 DGIs Ratio**
...
**Table 2-6: Summary table for CYP2D6 DGIs - AUC Ratio. (&delta; = 1.25 in Guest *et al.* formula)**

|AUC                          |Number |Ratio [%] |
|:----------------------------|:------|:---------|
|Points total                 |85     |-        |
|Points within Guest *et al.* |63     |74.12     |
...
**Table 2-7: Summary table for CYP2D6 DGIs - CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
**Table 2-8: Summary table for CYP2D6 DGIs**
...
|900077 |-, 40 mg, -, -  |Paroxetine, PO                         |3.20                |3.80               |0.84               |2.01                 |1.57                |1.28                |Mürdter 2016   |
|900078 |-, 40 mg, -, -  |Paroxetine, PO                         |2.63                |2.38               |1.10               |1.72                 |1.41                |1.22                |Mürdter 2016   |
|900079 |-, 40 mg, -, -  |Paroxetine, PO                         |2.70                |4.53               |0.60               |1.82                 |1.57                |1.16                |Mürdter 2016   |
|900080 |-, 40 mg, -, -  |Paroxetine, PO                         |2.34                |2.05               |1.14               |1.65                 |0.99                |1.66                |Mürdter 2016   |
|900081 |-, 40 mg, -, -  |Paroxetine, PO                         |0.43                |0.51               |0.85               |0.60                 |0.68                |0.89                |Mürdter 2016   |
|900082 |-, 40 mg, -, -  |Paroxetine, PO                         |8.24                |5.89               |1.40               |2.56                 |4.88                |0.52                |Yoon 2000      |
|900083 |-, 40 mg, -, -  |Paroxetine, PO                         |5.43                |1.49               |3.64               |1.91                 |1.43                |1.34                |Yoon 2000      |
|900084 |-, 40 mg, -, -  |Paroxetine, PO                         |2.46                |1.38               |1.78               |1.41                 |1.38                |1.03                |Yoon 2000      |
|900085 |-, 2 mg, -, -   |Risperidone, PO                        |2.84                |6.18               |0.46               |1.94                 |3.29                |0.59                |Bondolfi 2002  |

<br>
<br>

## 2.4 DDGI Evaluations<a id="ddgi-evaluations"></a>

The following section reports predicted and observed DDGI exposure ratios and the corresponding study-level tables. Concentration-time profiles stratified by genotype or phenotype are presented with the DDI profiles because each figure compares conditions without and with a perpetrator.
...
The ratio direction is predicted divided by observed. The identity line, two-fold limits, and Guest *et al.* limits are interpreted as described for the DDI ratio plots.

<a id="figure-2-9"></a>

![](images/004_section_ddi-evaluations/038_section_ddgi-evaluations/DDIRatio_2_ddi_ratio_plot_AUC_predictedVsObserved.png)

**Figure 2-9: CYP2D6 DDGIs.  Predicted vs. Observed AUC Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
![](images/004_section_ddi-evaluations/038_section_ddgi-evaluations/DDIRatio_2_ddi_ratio_plot_AUC_residualsVsObserved.png)

**Figure 2-10: CYP2D6 DDGIs.  Predicted/Observed vs. Observed AUC Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
![](images/004_section_ddi-evaluations/038_section_ddgi-evaluations/DDIRatio_2_ddi_ratio_plot_CMAX_predictedVsObserved.png)

**Figure 2-11: CYP2D6 DDGIs.  Predicted vs. Observed CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
![](images/004_section_ddi-evaluations/038_section_ddgi-evaluations/DDIRatio_2_ddi_ratio_plot_CMAX_residualsVsObserved.png)

**Figure 2-12: CYP2D6 DDGIs.  Predicted/Observed vs. Observed CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**
...
**Table 2-9: GMFE for CYP2D6 DDGIs Ratio**
...
**Table 2-10: Summary table for CYP2D6 DDGIs - AUC Ratio. (&delta; = 1.25 in Guest *et al.* formula)**

|AUC                          |Number |Ratio [%] |
|:----------------------------|:------|:---------|
|Points total                 |68     |-        |
|Points within Guest *et al.* |50     |73.53     |
...
**Table 2-11: Summary table for CYP2D6 DDGIs - CMAX Ratio. (&delta; = 1.25 in Guest *et al.* formula)**

|CMAX                         |Number |Ratio [%] |
|:----------------------------|:------|:---------|
|Points total                 |68     |-        |
|Points within Guest *et al.* |51     |75.00     |
...
**Table 2-12: Summary table for CYP2D6 DDGIs**
...
### 2.4.1 DDGI Study Evaluations<a id="ddgi-study-evaluations"></a>

#### 2.4.1.1 Paroxetine - Atomoxetine DDGI<a id="paroxetine-atomoxetine-ddgi"></a>
...
#### 2.4.1.2 Clarithromycin - Clomiphene DDGI<a id="clarithromycin-clomiphene-ddgi"></a>
...
#### 2.4.1.3 Paroxetine - Clomiphene DDGI<a id="paroxetine-clomiphene-ddgi"></a>
...
#### 2.4.1.4 Paroxetine - Desipramine DDGI<a id="paroxetine-desipramine-ddgi"></a>
...
#### 2.4.1.5 Paroxetine - Dextromethorphan DDGI<a id="paroxetine-dextromethorphan-ddgi"></a>
...
**Table 4-9: Clinical studies included for paroxetine-dextromethorphan DDGI**<a id="table-4-9"></a> b.i.d.: twice daily, f: female, IM: CYP2D6 intermediate metabolizer, m: male, N: number of study participants, NM: CYP2D6 normal metabolizer, po: oral, pop.: population used in simulations, QUI: quinidine, q.d.: once daily, s.d.: single dose. If perpetrator or victim drugs were applied in form of salts, the respective dose of base was calculated and incorporated in simulations.

#### 2.4.1.6 Quinidine - Metoprolol DDGI<a id="quinidine-metoprolol-ddgi"></a>
...
#### 2.4.1.7 Quinidine - Mexiletine DDGI<a id="quinidine-mexiletine-ddgi"></a>
...
Observed concentrations are shown as filled points and observed variability as error bars when reported. Population predictions are shown as lines. Control conditions are blue and conditions with a perpetrator are orange. Parent compounds precede metabolites within each study. Figure titles identify the study and treatment comparison. Time ranges are restricted to the clinically relevant observation period.
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/049_section_atomoxetine-desipramine-ddi-timeprofile/comparison_time_profile_Sauer_2004__Atomoxetine___Desipramine_DDI_62.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/050_section_atomoxetine-midazolam-ddi-timeprofile/comparison_time_profile_Sauer_2004__day_6__Atomoxetine___Midazolam_DDI_89.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/050_section_atomoxetine-midazolam-ddi-timeprofile/comparison_time_profile_Sauer_2004__day_12__Atomoxetine___Midazolam_DDI_90.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/051_section_carbamazepine-quinidine-ddi-timeprofile/comparison_time_profile_Andreasen_2007__Carbamazepine___Quinidine_DDI_7.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/052_section_cimetidine-metoprolol-ddi-timeprofile/comparison_time_profile_Chellingsworth_1988__Cimetidine___Metoprolol_DDI_72.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/052_section_cimetidine-metoprolol-ddi-timeprofile/comparison_time_profile_Chellingsworth_1988__Cimetidine___Metoprolol_DDI_73.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/052_section_cimetidine-metoprolol-ddi-timeprofile/comparison_time_profile_Toon_1988__Cimetidine___Metoprolol_DDI_74.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/052_section_cimetidine-metoprolol-ddi-timeprofile/comparison_time_profile_Kirch_1982__Cimetidine___Metoprolol_DDI_75.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/053_section_cimetidine-quinidine-ddi-timeprofile/comparison_time_profile_Kolb_1984__Cimetidine___Quinidine_DDI_8.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/053_section_cimetidine-quinidine-ddi-timeprofile/comparison_time_profile_Hardy_1988__Cimetidine___Quinidine_DDI_9.png)
...
### 3.1.6 Clarithromycin - Clomiphene DDGI<a id="clarithromycin-clomiphene-ddgi-timeprofile"></a>

<a id="figure-3-11"></a>

![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_22.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_23.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_24.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_25.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_26.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_27.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_28.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_29.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_30.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_31.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_32.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_33.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_34.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_35.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_36.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_37.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_38.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_39.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_40.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles/054_section_clarithromycin-clomiphene-ddgi-timeprofile/comparison_time_profile_Murdter_2016__Clarithromycin___Clomiphene_DDI_41.png)
...
![](images/047_section_concentration-time-profiles/048_section_ddi-concentration-time-profiles
prolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Huang_1999__Metoprolol_DGI___R_Metoprolol_123.png)

**Figure 3-125: Huang 1999: Metoprolol DGI - R-Metoprolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Kirchheiner_Seeringer_2008__Metoprolol_DGI___R_Metoprolol_124.png)

**Figure 3-126: Kirchheiner/Seeringer 2008: Metoprolol DGI - R-Metoprolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Kirchheiner_Seeringer_2008__Metoprolol_DGI___R_Metoprolol_125.png)

**Figure 3-127: Kirchheiner/Seeringer 2008: Metoprolol DGI - R-Metoprolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Sharma_2005__Metoprolol_DGI___S_Metoprolol_126.png)

**Figure 3-128: Sharma 2005: Metoprolol DGI - S-Metoprolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Huang_1999__Metoprolol_DGI___S_Metoprolol_127.png)

**Figure 3-129: Huang 1999: Metoprolol DGI - S-Metoprolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Huang_1999__Metoprolol_DGI___S_Metoprolol_128.png)

**Figure 3-130: Huang 1999: Metoprolol DGI - S-Metoprolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Kirchheiner_Seeringer_2008__Metoprolol_DGI___S_Metoprolol_129.png)

**Figure 3-131: Kirchheiner/Seeringer 2008: Metoprolol DGI - S-Metoprolol**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/084_section_metoprolol-dgi-timeprofile/comparison_time_profile_Kirchheiner_Seeringer_2008__Metoprolol_DGI___S_Metoprolol_130.png)
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/085_section_mexiletine-dgi-timeprofile/comparison_time_profile_Abolfathi_1993__Mexiletine_DGI___Mexiletine_131.png)

**Figure 3-133: Abolfathi 1993: Mexiletine DGI - Mexiletine**

<br>
<br>

### 3.2.7 Risperidone DGI<a id="risperidone-dgi-timeprofile"></a>

<a id="figure-3-134"></a>

![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/086_section_risperidone-dgi-timeprofile/comparison_time_profile_Novalbos_2010__Risperidone_DGI___Risperidone_105.png)

**Figure 3-134: Novalbos 2010: Risperidone DGI - Risperidone**
...
![](images/047_section_concentration-time-profiles/079_section_dgi-concentration-time-profiles/086_section_risperidone-dgi-timeprofile/comparison_time_profile_Novalbos_2010__Risperidone_DGI___9_Hydroxyrisperidone_106.png)

**Figure 3-135: Novalbos 2010: Risperidone DGI - 9-Hydroxyrisperidone**
...
The CYP2D6 DDGI network was qualified against clinical DDI, DGI, and DDGI data for AUC and C<sub>max</sub> ratios across the selected perpetrator and victim combinations. The aggregate analysis includes every evaluable ratio in the three study-level result tables: 177 AUC ratios and 176 C<sub>max</sub> ratios. One DDI record without an evaluable C<sub>max</sub> ratio is excluded from the C<sub>max</sub> analysis.

| PK parameter | n | GMFE | Within Guest *et al.* limits, n (%) | Within two-fold limits, n (%) |
|:-------------|--:|-----:|------------------------------------:|---------------------------------:|
| AUC | 177 | 1.47 | 134 (75.71%) | 150 (84.75%) |
| C<sub>max</sub> | 176 | 1.39 | 133 (75.57%) | 155 (88.07%) |

**Table 5-1: Aggregate CYP2D6 DDI, DGI, and DDGI qualification performance (δ = 1.25 in Guest *et al.* formula)**

The network supports the intended use of the OSP Suite for CYP2D6-mediated DDI and DDGI simulations within the evaluated scenarios. Remaining deviations indicate that model performance should be interpreted together with the underlying interaction mechanism, genotype group, victim drug, perpetrator drug, and analyte.
