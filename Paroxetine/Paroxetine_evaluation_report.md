...
| ----------------------------------------------- | ------------------------------------------------------------ |
| based on *Model Snapshot* and *Evaluation Plan* | https://github.com/Open-Systems-Pharmacology/Paroxetine-Model/releases/tag/vmain |
| OSP Version                                     | 12.2                                                          |
...
This whole-body PBPK model of paroxetine has been developed using published pharmacokinetic clinical data by [Lund 1982](References.md), [Belle 2002](References.md), [Massaroti 2005](References.md), [Mürdter 2016](References.md), [Sindrup 1992](References.md), and [Yoon 2000](References.md). The clinical data included intravenous infusion, immediate-release oral dosing, tablet dosing, controlled-release oral dosing, and repeated dosing across a dose range of 20 to 70 mg paroxetine. The model was then evaluated with clinical studies including [Calvo 2004](References.md), [Chen 2015](References.md), [McClelland 1984](References.md), [Schoedel 2012](References.md), [Segura 2005](References.md), [van der Lee 2007](References.md), [Yasui-Furukori 2007a](References.md), [Yasui-Furukori 2007b](References.md), [Mürdter 2016](References.md), and [Yoon 2000](References.md).
...
The general concept of building a PBPK model has previously been described by Kuepfer et al. ([Kuepfer 2016](References.md)). Relevant information on anthropometric (height, weight) and physiological parameters (e.g. blood flows, organ volumes, binding protein concentrations, hematocrit, cardiac output) in adults was gathered from the literature and has been previously published ([Willmann 2007](References.md)). The information was incorporated into PK-Sim® and was used as default values for the simulations in adults.

The applied activity and variability of plasma proteins and active processes that are integrated into PK-Sim® are described in the publicly available PK-Sim® Ontogeny Database Version 7.3 ([PK-Sim Ontogeny Database Version 7.3](References.md)) or otherwise referenced for the specific process.

The paroxetine base model was developed sequentially. Model-building data from intravenous paroxetine administration in [Lund 1982](References.md) supported the selection of partition-coefficient and cellular-permeability calculation methods. Oral single-dose and multiple-dose data from [Lund 1982](References.md), [Belle 2002](References.md), [Massaroti 2005](References.md), [Sindrup 1992](References.md), [Mürdter 2016](References.md), and [Yoon 2000](References.md) informed oral absorption, CYP2D6-independent metabolism, and CYP2D6-mediated metabolism.
...
The model was built with data supporting distribution, oral absorption, CYP2D6-dependent clearance, CYP2D6-independent clearance, and controlled-release dissolution. Intravenous data from [Lund 1982](References.md) supported systemic disposition independent of oral absorption. Oral data from [Belle 2002](References.md), [Massaroti 2005](References.md), [Mürdter 2016](References.md), [Sindrup 1992](References.md), and [Yoon 2000](References.md) supported oral absorption, repeated-dose behavior, and CYP2D6 activity-score-dependent clearance. Verification used independent immediate-release and controlled-release oral studies, including [Chen 2015](References.md), [McClelland 1984](References.md), [Schoedel 2012](References.md), [Segura 2005](References.md), [van der Lee 2007](References.md), and [Yasui-Furukori 2006](References.md).
...
Fraction unbound (plasma, reference value)       | 0.0487321988    | Publication-In Vitro-Kaye et al 1989                        | Measurement             | True   
...
**Table 3-1: GMFE for Goodness of fit plot for paroxetine concentration in plasma.**

|Group                                                |GMFE |
|:----------------------------------------------------|:----|
|Paroxetine plasma concentration (model building)     |1.35 |
|Paroxetine plasma concentration (model verification) |1.59 |
|All                                                  |1.46 |
...
**Figure 3-1: Goodness of fit plot for paroxetine concentration in plasma.**
...
**Figure 3-2: Goodness of fit plot for paroxetine concentration in plasma.**
...
The presented PBPK model adequately describes paroxetine pharmacokinetics in the evaluated adult intravenous, oral immediate-release, controlled-release, and CYP2D6 activity-score settings.
