...
The model was implemented as a parent-metabolite model for ketoconazole, N-deacetylketoconazole and N-deacetyl-N-hydroxyketoconazole. Ketoconazole plasma profiles from oral solution, capsule-as-solution and tablet studies were used to inform absorption, dissolution and disposition parameters, while the Weiss et al. clinical data provided the only plasma concentration-time profiles for N-deacetylketoconazole [Weiss 2022](References.md#5-references).

Ketoconazole absorption was evaluated across fasted and fed dosing conditions, including solution, capsule-as-solution and tablet formulations. The model includes CYP3A4-mediated metabolism, arylacetamide deacetylase-mediated N-deacetylketoconazole formation, UGT1A4-mediated metabolism, P-gp transport and reversible inhibition of CYP3A4 and P-gp by ketoconazole and metabolites. The resulting model structure supports both concentration-time profile evaluation and DFI or DDI perpetrator simulations [Marok 2023](References.md#5-references).

## 2.2 Data used<a id="22"></a>

Clinical plasma concentration-time profiles were taken from the published studies compiled for the model publication [Marok 2023](References.md#5-references). The dataset covers oral single-dose and multiple-dose ketoconazole administration in adults, fasted and fed states, and doses from 100 mg to 1200 mg.

| Publication | Data used |
| --- | --- |
| [Heel 1982](References.md#5-references) | Oral solution and tablet ketoconazole studies in adults under fasted conditions. |
| [Daneshmend 1981](References.md#5-references), [Daneshmend 1983](References.md#5-references), [Daneshmend 1984](References.md#5-references) | Oral ketoconazole studies in adults covering fasted, fed, single-dose and multiple-dose administration. |
| [Huang 1986](References.md#5-references) | Oral solution and tablet ketoconazole data in healthy adults. |
| [Polk 1999](References.md#5-references), [Boyce 2012](References.md#5-references), [Tiseo 1998](References.md#5-references), [Craven 1983](References.md#5-references), [Männistö 1982](References.md#5-references), [Greenblatt 1998](References.md#5-references) | Oral ketoconazole clinical data used to evaluate formulation, food-effect and multiple-dose performance. |
| [Weiss 2022](References.md#5-references) | Oral ketoconazole study in adults with plasma profiles for ketoconazole and N-deacetylketoconazole. |

Physicochemical, transporter and metabolic information was taken from experimental literature and in silico calculations. Ketoconazole and metabolite pK<sub>a</sub>, lipophilicity and solubility parameters were informed by Chemicalize and formulation-relevant dissolution data, while in vitro metabolism and inhibition data were taken from studies on AADAC, CYP3A4, P-gp and UGT pathways [Fukami 2016](References.md#5-references), [Fitch 2009](References.md#5-references), [Schwab 2003](References.md#5-references), [Bourcier 2010](References.md#5-references), [Weiss 2022](References.md#5-references).

The FMO3 K<sub>m</sub> value of 1.17 µmol/L implemented for N-deacetylketoconazole is correct. The corresponding value reported by [Marok 2023](References.md#5-references) is erroneous.

## 2.3 Model parameters and assumptions<a id="23"></a>

#### Absorption and formulations

The model includes oral solution, capsule-as-solution and tablet applications. Solution and capsule-as-solution scenarios were used to separate systemic disposition from dissolution-limited tablet absorption. Tablet absorption was described with formulation-specific dissolution and particle-size assumptions, with fed-state scenarios used to describe the reduced and delayed absorption observed for weak-base ketoconazole under altered gastrointestinal conditions [Marok 2023](References.md#5-references), Table 1.

#### Distribution

Ketoconazole is a weak base with high plasma protein binding and pH-dependent solubility. Distribution parameters were based on physicochemical properties and PBPK tissue partitioning methods, with optimized lipophilicity where required to reproduce systemic exposure. The metabolites were represented as separate compounds with their own physicochemical properties and protein-binding assumptions [Marok 2023](References.md#5-references), Table 1.

#### Metabolism, transport and inhibition

Ketoconazole metabolism includes formation of N-deacetylketoconazole by arylacetamide deacetylase and further metabolism through CYP3A4 and UGT pathways. Ketoconazole and metabolites were represented as CYP3A4 and P-gp inhibitors, which is required to describe the observed DDI perpetrator behavior more accurately than a parent-only inhibition model [Marok 2023](References.md#5-references), Table 1, and [Weiss 2022](References.md#5-references).
