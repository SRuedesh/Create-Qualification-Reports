...
Drug-dependent input parameters for the metoprolol enantiomers were taken from the published metoprolol PBPK model and the cited primary sources therein [[1](References.md)]. The key physicochemical properties include molecular weight, pK<sub>a</sub>, lipophilicity, solubility of metoprolol tartrate and succinate, fraction unbound in plasma and intestinal permeability. The model uses the same physicochemical properties for the two enantiomers where no enantiomer-specific difference is supported by the source data.

CYP2D6 K<sub>m</sub> values for α-hydroxylation and O-demethylation are based on in vitro data by Mautz et al. [[15](References.md)] as summarized in the metoprolol model publication [[1](References.md)]. activity-score-dependent k<sub>cat</sub> values were optimized in fixed pathway ratios and are documented in the model publication [[1](References.md), Table 3].

| Parameter group | Model use | Main source |
| --- | --- | --- |
| Molecular weight, pK<sub>a</sub>, lipophilicity, solubility and f<sub>u</sub> | Parent-enantiomer physicochemical and distribution inputs | [Rüdesheim et al. 2020](References.md), Table 2 and cited primary sources |
| CYP2D6 K<sub>m</sub> values | Enantiomer-specific α-hydroxylation and O-demethylation | [Rüdesheim et al. 2020](References.md), Table 2 |
| CYP2D6 activity-score-dependent k<sub>cat</sub> values | DGI model scaling across CYP2D6 activity scores | [Rüdesheim et al. 2020](References.md), Table 3 |
| Formulation parameters | Normal-release tartrate and controlled-release succinate absorption | [Rüdesheim et al. 2020](References.md), Table 2 |
...
| --- | --- |
| [Kirchheiner et al. 2004 / Seeringer et al. 2008](References.md) | Oral normal-release metoprolol tartrate data in adult CYP2D6 poor, normal and ultrarapid metabolizer groups were used to inform activity-score-dependent enantiomer metabolism. |
| [Sharma et al. 2005](References.md) | Oral metoprolol tartrate data in adult CYP2D6 poor and normal metabolizer groups supported racemic and enantiomer-specific DGI evaluation. |
| [Regårdh et al. 1974](References.md), [Regårdh et al. 1980](References.md), [Johnsson et al. 1975](References.md), [Kelly et al. 1985](References.md) and [Godbillon et al. 1985](References.md) | Intravenous infusion and oral metoprolol studies in adults supported systemic disposition, oral absorption and metabolite formation across the model-building dataset. |
| [Werner et al. 2003](References.md), [Krösser et al. 2006](References.md) and [Jin et al. 2008](References.md) | Oral metoprolol tartrate studies with metoprolol and α-hydroxymetoprolol measurements supported parent-metabolite evaluation and activity-score-dependent predictions. |
| [Huang et al. 1999](References.md), [Hamelin et al. 2000](References.md), [Johnson et al. 1996](References.md), [Luzier et al. 1999](References.md), [Stout et al. 2011](References.md), [Parker et al. 2011](References.md), [Damy et al. 2004](References.md) and [Bae et al. 2014](References.md) | Oral metoprolol tartrate or succinate data in adults provided additional verification across CYP2D6 status groups, sex groups and formulation conditions. |
...
Name                                       | Value                  | Value Origin                                                | Alternative | Default
------------------------------------------ | ---------------------- | ----------------------------------------------------------- | ----------- | -------
Solubility at reference pH                 | 1430 mg/l              | Database-Other-HMDB                                         | Predicted   | True   
...
**Table 3-1: GMFE for Metoprolol racemate observed versus simulated plasma concentration-time data**
...
**Figure 3-1: Metoprolol racemate observed versus simulated plasma concentration-time data**
...
**Figure 3-2: Metoprolol racemate observed versus simulated plasma concentration-time data**
...
**Table 3-2: GMFE for (R)-Metoprolol observed versus simulated plasma concentration-time data**
...
**Figure 3-3: (R)-Metoprolol observed versus simulated plasma concentration-time data**
...
**Figure 3-4: (R)-Metoprolol observed versus simulated plasma concentration-time data**
...
**Table 3-3: GMFE for (S)-Metoprolol observed versus simulated plasma concentration-time data**
...
**Figure 3-5: (S)-Metoprolol observed versus simulated plasma concentration-time data**
...
**Figure 3-6: (S)-Metoprolol observed versus simulated plasma concentration-time data**
...
**Table 3-4: GMFE for α-Hydroxymetoprolol observed versus simulated plasma concentration-time data**
...
**Figure 3-7: α-Hydroxymetoprolol observed versus simulated plasma concentration-time data**
...
**Figure 3-8: α-Hydroxymetoprolol observed versus simulated plasma concentration-time data**
...
![](images/006_section_3/013_section_33/014_section_331/1_time_profile_plot_Metoprolol_Johnsson_1975__5_mg_tartrate_iv_10_min__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/2_time_profile_plot_Metoprolol_Regardh_1974__5_mg_tartrate_iv_10_min__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/3_time_profile_plot_Metoprolol_Johnsson_1975__10_mg_tartrate_iv_10_min__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/4_time_profile_plot_Metoprolol_Regardh_1980__10_mg_tartrate_iv_5_min__n_6.png)
...
![](images/006_section_3/013_section_33/014_section_331/5_time_profile_plot_Metoprolol_Johnsson_1975__15_mg_tartrate_iv_10_min__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/6_time_profile_plot_Metoprolol_Johnsson_1975__20_mg_tartrate_iv_10_min__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/7_time_profile_plot_Metoprolol_Kelly_1985__50_mg_tartrate_iv_10_min__n_12.png)
...
![](images/006_section_3/013_section_33/014_section_331/8_time_profile_plot_Metoprolol_Godbillon_1985__88_7_mg_tartrate_iv_150_min__n_6.png)
...
![](images/006_section_3/013_section_33/014_section_331/9_time_profile_plot_Metoprolol_Regardh_1974__5_mg_tartrate_solution__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/10_time_profile_plot_Metoprolol_Johnsson_1975__20_mg_tartrate_IR__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/11_time_profile_plot_Metoprolol_Johnsson_1975__50_mg_tartrate_IR__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/12_time_profile_plot_Metoprolol_Johnsson_1975__100_mg_tartrate_IR__n_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/13_time_profile_plot_Metoprolol_Kelly_1985__100_mg_tartrate_IR__n_12_md.png)
...
![](images/006_section_3/013_section_33/014_section_331/15_time_profile_plot_Metoprolol_Werner_2003_NM__50_mg_tartrate_IR__n_12__AS_1_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/20_time_profile_plot_Metoprolol_Huang_1999_IM__100_mg_tartrate_IR__n_12__AS_0_5.png)
...
![](images/006_section_3/013_section_33/014_section_331/21_time_profile_plot_Metoprolol_Huang_1999_NM__100_mg_tartrate_IR__n_16__AS_2.png)
...
![](images/006_section_3/013_section_33/014_section_331/22_time_profile_plot_Metoprolol_Huang_1999_NM__100_mg_tartrate_IR__n_12__AS_1_25.png)
...
![](images/006_section_3/013_section_33/014_section_331/23_time_profile_plot_Metoprolol_Jin_2008_IM__100_mg_tartrate_IR__n_5__AS_0_5.png)
...
![](images/006_section_3/013_section_33/014_section_331