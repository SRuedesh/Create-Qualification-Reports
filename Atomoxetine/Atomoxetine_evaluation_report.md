...
| --- | ---: | ---: | --- | --- |
| Atomoxetine MW | g/mol | 255.35 | [Zhong 2013](#5-references) | Compound size used in concentration conversions. |
| Atomoxetine pK<sub>a</sub> base | - | 9.80 | [Swain 2012](#5-references) | Basic ionization constant. |
| Atomoxetine solubility, pH 7.4 | mg/mL | 10.29 | [Swain 2012](#5-references) | Solubility input. |
| Atomoxetine f<sub>u</sub> | % | 1.30 | [Yu 2016](#5-references) | Plasma binding input. |
| Atomoxetine CYP2D6 K<sub>m</sub> | µmol/L | 2.30 | [Ring 2002](#5-references) | CYP2D6 affinity held constant across activity scores. |
| Atomoxetine CYP2D6 k<sub>cat</sub> EM | 1/min | 37.44 | Optimized; [Ring 2002](#5-references) | activity-score-dependent CYP2D6 clearance. |
| Atomoxetine CYP2D6 k<sub>cat</sub> PM | 1/min | 0 | Assumed | CYP2D6 poor-metabolizer activity set to zero. |
| Atomoxetine CYP2C19 K<sub>m</sub> | µmol/L | 83.00 | [Ring 2002](#5-references) | CYP2C19 affinity parameter. |
| Atomoxetine CYP2C19 k<sub>cat</sub> | 1/min | 165.23 | Optimized; [Ring 2002](#5-references) | Non-CYP2D6 metabolic clearance surrogate. |
...
| --- | --- |
| [Nakano 2016](#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 50 mg atomoxetine as solution or capsule with CYP2D6 extensive-metabolizer status. |
| [Byeon 2015](#5-references) | Plasma PK profile in adults after oral, single-dose administration of 40 mg atomoxetine with CYP2D6 AS = 2 status. |
| [Kim 2018](#5-references) | Plasma PK profile in adults after oral, single-dose administration of 20 mg atomoxetine with CYP2D6 AS = 2 status. |
| [Sauer 2003](#5-references) | Plasma PK profiles in adults after repeated oral administration of 20 mg atomoxetine with CYP2D6 extensive- and poor-metabolizer status. |

Model-verification clinical data:

| Publication | Arm / Treatment / Information used for model verification |
| --- | --- |
| [Belle 2002](#5-references) | Plasma PK profiles in adults after oral, once daily administration of 20 mg atomoxetine with CYP2D6 extensive-metabolizer status. |
| [Cui 2007](#5-references) | Plasma PK profiles in adults after oral administration of 40 mg and 80 mg atomoxetine with CYP2D6 AS = 1 status. |
| [Byeon 2015](#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 40 mg atomoxetine with CYP2D6 AS = 0.5 and AS = 1.25 status. |
| [Kim 2018](#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 20 mg atomoxetine with CYP2D6 AS = 0.5 status. |
| [Todor 2016](#5-references) | Plasma PK profiles in adults after oral, single-dose administration of 25 mg atomoxetine with CYP2D6 normal- and poor-metabolizer status. |
